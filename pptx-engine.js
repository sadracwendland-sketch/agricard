...
const PptxEngine = {
  ...
  _buildFont(run) {
    ...
    const family = run.fontFamily && run.fontFamily !== '+mj-lt' && run.fontFamily !== '+mn-lt'
      ? `"${run.fontFamily}", Inter, Arial, sans-serif`
